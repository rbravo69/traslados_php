...
<head>
    ...
    <link rel="icon" href="../assets/img/paloma_afavor.png" type="image/png">
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <a href="index.php">
                            <img src="../assets/img/afavor_transparent.png" alt="Logo" class="h-9 w-auto"> <!-- Agrega tu logo aquí -->
                        </a>
                    </div>

                    <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <a href="../index.php" class="text-gray-800 dark:text-gray-200 hover:text-gray-400">Inicio</a>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <a href="../templates/traslado.php" 
                        class="text-gray-800 dark:text-gray-200 hover:text-gray-400">Traslados</a>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <a href="../templates/consultaTraslados.php" 
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php if (isset($_SESSION['usuario'])){ ?>
                        ...
                        <a href="../logout.php" class="text-gray-800 dark:text-gray-200 hover:text-gray-400">Cerrar sesión</a>
                    <?php }else{?>
                        <!-- Si el usuario no está autenticado -->
                        <a href="../login.php" class="text-gray-800 dark:text-gray-200 hover:text-gray-400">Iniciar sesión</a>
                    <?php }; ?>
                </div>
            </div>
        </div>
